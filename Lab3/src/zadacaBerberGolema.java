 ...
 * @author ristes
 */
public class zadacaBerberGolema {
    ...
    static Semaphore imCut;
    static Semaphore permissionToWakeUp;
    static Semaphore readyToCutTheBalls;
    static Semaphore canPay;
    static Semaphore isSleeping;
    ...
    public static void init(int numBarbers) {
        ...
        imCut = new Semaphore(0);
        permissionToWakeUp = new Semaphore(0);
        readyToCutTheBalls = new Semaphore(0);
        canPay = new Semaphore(0);
        isSleeping = new Semaphore(1);
    ...
    static class Barber extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            permissionToWakeUp.acquire();
            state.barberWakeUp();

            synchronized(zadacaBerberGolema.class) {
