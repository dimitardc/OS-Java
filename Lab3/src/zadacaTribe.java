 ...
 * @author ristes
 */
public class zadacaTribe {

    // TODO: definirajte gi semaforite i ostanatite promenlivi ovde (mora site
    // da se static)
    static Semaphore proveri;
    static Semaphore zemiHrana;
    ...
    public static void init(int numBarbers) {
        proveri = new Semaphore(1);
        zemiHrana = new Semaphore(3);
    }
    ...
    static class TribeMember extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            // nesinhronizirano scenario            proveri = new Semaphore(1);
            proveri.acquire();                              //      zemiHrana = new Semaphore(3);
            if (!state.isPotEmpty()) {
                proveri.release();
                zemiHrana.acquire();
                state.fillPlate();
